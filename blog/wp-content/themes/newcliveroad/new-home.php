		...
		<div class="homeSlider">
			...
			<div class="item <?php echo $blog_banner_reslt->ID?>">
				<div class="slider-img" style="overflow: hidden;padding: 0% 5%;">
					<a href="<?php get_permalink($blog_banner_reslt->ID) ?>" style="background: url(<?php echo $url ?>) no-repeat center center / cover; display: block;"><img src="<?php echo $url ?>" title="<?php echo $blog_banner_reslt->post_title; ?>" alt="<?php echo alt_tag( $blog_banner_reslt->ID ) ?>" style="opacity:0;"/></a>
				</div>
